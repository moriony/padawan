...
#### Задание:
Выполняя данное задание необходимо продемонстрировать умение работать с ветками, сливать несколько веток, использовать .gitignore, использовать stash, работать с pull request'ами.
